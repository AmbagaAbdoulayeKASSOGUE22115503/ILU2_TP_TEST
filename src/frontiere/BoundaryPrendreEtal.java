...
public class BoundaryPrendreEtal {
	...
	public void prendreEtal(String nomVendeur) {
		...
		if(!nomVendeurConnu) {
			...
			System.out.println("Bonjour "+nomVendeur+", je vais regarder si je "
					+ "peux vous trouver un étal.");
	...
	private void installerVendeur(String nomVendeur) {
		...
		int nbPorduit = Clavier.entrerEntier("Combien souhaitez vous en vendre?");
		
		int numeroEtal = controlPrendreEtal.prendreEtal(nomVendeur, produit, nbPorduit);
		if(numeroEtal!=-1)
